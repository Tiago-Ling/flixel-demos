 ...
 */
class FlxIsoTile extends FlxObject
{
	/**
	 ...
	 */
	public var tilemap:FlxIsoTilemap;
	/**
	 ...
	 * @param 	Width			The width of the tile. Same as used in an orthographic tilemap
	 ...
	 */
	public function new(Tilemap:FlxIsoTilemap, Index:Int, Width:Float, Depth:Float, Height:Float, Visible:Bool, AllowCollisions:Int)
	{
		super(0, 0, Width, (Depth + Height));
